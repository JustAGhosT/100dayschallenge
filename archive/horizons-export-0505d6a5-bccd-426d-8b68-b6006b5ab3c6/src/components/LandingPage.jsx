...
import { Code, CheckSquare, Github, Globe } from 'lucide-react';
...
export function LandingPage({ onSignInGitHub, onSignInGoogle }) {
    ...
    <div className="flex flex-col items-center justify-center min-h-screen text-center p-4">
      ...
      >
        ...
        <h1 className="text-4xl md:text-6xl font-bold text-white mb-4 bg-gradient-to-r from-purple-400 to-blue-400 bg-clip-text text-transparent">
          The Developer Challenge Hub
        </h1>
        <p className="text-lg md:text-xl text-purple-200 mb-8 max-w-2xl mx-auto">
          Track, document, and showcase your coding journey. Join a challenge, build your portfolio, and accelerate your growth.
        </p>

        <div className="flex flex-col md:flex-row gap-4 justify-center mb-10">
          <Button onClick={onSignInGitHub} size="lg" className="bg-gray-800 hover:bg-gray-700 text-white px-6 py-3 text-base font-semibold rounded-xl shadow-lg w-full md:w-auto">
            <Github className="w-5 h-5 mr-2" /> Sign In with GitHub
          </Button>
          <Button onClick={onSignInGoogle} size="lg" className="bg-white hover:bg-gray-100 text-gray-800 px-6 py-3 text-base font-semibold rounded-xl shadow-lg w-full md:w-auto">
              ...
              >
                <div className="flex items-center mb-3">
                  ...
                  <div>
                    ...
                    <p className="text-blue-300">{challenge.goal_apps} Apps</p>
                  </div>
                </div>
